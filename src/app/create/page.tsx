  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* --- LEFT SIDEBAR --- */}
        <aside className={cn(
          "w-full max-w-[400px] h-full overflow-y-auto border-r p-6 z-20 shrink-0 scrollbar-hide",
        ...
        <div className="flex-1 h-full relative overflow-y-auto scrollbar-hide">
          ...
          {/* 👇 INTEGRATED ACERNITY BACKGROUND 👇 */}
          <GridBackgroundDemo isDark={isGlobalDark} />


          {/* --- CONTENT CENTER WRAPPER --- */}
          <div className="min-h-full flex flex-col items-center justify-center p-8 lg:p-12 relative z-10">

            <div className="relative scale-[0.85] md:scale-95 xl:scale-100 transition-transform duration-300">
              <TwitterPost id="tweet-canvas" />
            </div>

            {/* Action Bar */}
            <div className={cn(
              "mt-8 flex items-center gap-4 backdrop-blur-xl p-2 pl-4 rounded-full border shadow-2xl transition-all duration-300 hover:scale-105",
              isGlobalDark
